...
contract CurvePoolCodec is ICodec {
    ...
    function encodeCalldataWithOverride(bytes calldata _data, uint256 _amountInOverride, address /*receiverOverride*/) external pure returns (bytes memory swapCalldata) {
